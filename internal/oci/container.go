...
func (c *Container) Description() string {
	return fmt.Sprintf("%s/%s/%s", c.Labels()[ktypes.KubernetesPodNamespaceLabel], c.Labels()[ktypes.KubernetesPodNameLabel], c.Labels()[ktypes.KubernetesContainerNameLabel])
}
