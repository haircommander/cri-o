...
func serverNetworkStatToCRI(from *types.NetworkStats) *pb.NetworkStats {
	if from == nil {
		return nil
	}
	to := &pb.NetworkStats{
	...
	if from.Interfaces != nil {
		to.Interfaces = make([]*pb.InterfaceStats, 0, len(from.Interfaces))
...
func serverInterfaceStatToCRI(from *types.InterfaceStats) *pb.InterfaceStats {
	if from == nil {
		return nil
	}
	to := &pb.InterfaceStats{
		Name: from.Name,
	}
	if from.RxBytes != nil {
...
func serverProcessStatToCRI(from *types.ProcessStats) *pb.ProcessStats {
	if from == nil {
		return nil
	}
	to := &pb.ProcessStats{
